        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="relative w-full h-[50vh] md:h-[60vh] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center px-4 bg-black/30">
                    <h1 className="text-white text-xl md:text-3xl font-jaini text-center max-w-4xl leading-tight drop-shadow-2xl">
            ...
            <main className="flex-grow container mx-auto px-4 py-16 -mt-24 relative z-10 max-w-5xl">
                {/* Combined Card: HOPE3 Text + Feedback Form */}
                <section className="py-8 px-6 bg-blue-50 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.25)] border border-gray-100 max-w-2xl mx-auto">
                    {/* HOPE3 Intro Text */}
                    <div className="rounded-xl shadow-md p-6 text-center text-gray-800 bg-[#e8f5e8] mb-8">
                        <p className="leading-relaxed text-gray-700 text-left text-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className="w-full p-2.5 border border-gray-300 rounded-lg outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-200 transition-all text-sm min-h-[140px] resize-none overflow-hidden"
                            ></textarea>
                        </div>
                        ...
                        <div className="flex justify-center pt-4">
                            <button
                                type="submit"
                                className="group relative flex items-center justify-center gap-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 px-12 rounded-xl font-bold text-base hover:from-purple-700 hover:to-indigo-700 transform hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl mt-4 min-w-[200px]"
                            >
