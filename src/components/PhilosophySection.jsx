    ...
    <section className="py-20 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-stretch">
          {/* Left Side - Buttons */}
          <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-l-4 border-blue-500 p-6 space-y-2 w-full max-w-xs">
            {buttons.map((key) => (
              <button
                key={key}
                onClick={() => setActivePhilosophy(key)}
                className={`w-full text-left px-3 py-2 rounded-lg transition-all duration-300 shadow-[0_4px_15px_rgb(0,0,0,0.1)] hover:shadow-[0_6px_20px_rgb(0,0,0,0.15)] text-base ${
          ...
          <div className="flex items-start flex-1">
            <div className="rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-r-4 border-blue-500 p-6 w-full max-w-2xl h-full flex items-center" style={{backgroundColor: '#A0B6E6'}}>
